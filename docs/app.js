...
function showAllAttributes() {
    ...
    const attributes = {
        "Element 9: Location Type": {
            ...
            droppedValues: ["09", "20", "25", "53"],
            values: [
                { code: "DA", desc: "Drug Store/Pharmacy", mapsTo: "09 (FBI)" },
                { code: "DB", desc: "Doctor's Office", mapsTo: "09 (FBI)" },
                { code: "DC", desc: "Medical Clinic", mapsTo: "09 (FBI)" },
                { code: "DG", desc: "Hospital", mapsTo: "09 (FBI)" },
                { code: "DI", desc: "Marijuana Dispensary", mapsTo: "09 (FBI)" },
                { code: "GA", desc: "Library", mapsTo: "11 (FBI)" },
                { code: "GB", desc: "Museum", mapsTo: "11 (FBI)" },
                { code: "GC", desc: "Zoo", mapsTo: "11 (FBI)" },
                { code: "RA", desc: "Single Family Home", mapsTo: "20 (FBI)" },
                { code: "RB", desc: "Multiple Family Dwelling", mapsTo: "20 (FBI)" },
                { code: "RC", desc: "Apartment/Condo", mapsTo: "20 (FBI)" },
                { code: "RD", desc: "Hotel/Motel", mapsTo: "20 (FBI)" },
                { code: "RE", desc: "Garage (Residential)", mapsTo: "20 (FBI)" },
                { code: "RF", desc: "Yard (Residential)", mapsTo: "20 (FBI)" },
                { code: "RG", desc: "Driveway (Residential)", mapsTo: "20 (FBI)" },
                { code: "SA", desc: "Loan/Cash Advance", mapsTo: "24 (FBI)" },
                { code: "OA", desc: "Other", mapsTo: "25 (FBI)" },
                { code: "OF", desc: "Unknown", mapsTo: "25 (FBI)" },
                { code: "S1", desc: "School - Elementary", mapsTo: "53 (FBI)" },
                { code: "S2", desc: "School - Junior High", mapsTo: "53 (FBI)" },
                { code: "S3", desc: "School - High School", mapsTo: "53 (FBI)" }
            ]
        },
        ...
        "Element 28/39/49: Race (Victim/Offender/Arrestee)": {
            ...
            droppedValues: ["A (Asian)", "P (Pacific Islander)"],
            values: [
                { code: "W", desc: "White" },
